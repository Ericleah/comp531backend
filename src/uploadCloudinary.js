...
const doUpload = (publicId, req, res, next) => {
  cloudinary.uploader.destroy(req.body[publicId], function (result) {
    if (result) {
...
const getImageUrl = (publicId) => cloudinary.url(publicId);
///////////////////////////////////////////////////////////////////////////////
...
res.send(`Uploaded: ${getImageUrl(req.fileid)}<br/><a href="${req.fileurl}">${image}</a>`);
}
...
module.exports = { uploadImage, setup, getImageUrl }